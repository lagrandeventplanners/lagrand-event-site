      ...
      <form ref={formRef} encType="multipart/form-data">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: "1.25rem", alignItems: "start" }}>
          ...
          <div style={{ position: "sticky", top: "76px", display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            {/* TAGS */}
            <div style={card}>
              <label style={lbl}><Tag size={11} /> Tags</label>
              ...
              <p style={{ fontSize: "0.6rem", color: "rgba(245,240,232,0.2)", fontFamily: "var(--font-body)", margin: "0.75rem 0 0.4rem", letterSpacing: "0.1em", textTransform: "uppercase" }}>Quick add</p>
